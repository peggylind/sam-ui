...
<div style={{position:"absolute",width:model_explanations(this.state.explainIndex).div_width,
              left:model_explanations(this.state.explainIndex).div_left,height:"95%",
  ...
  {(model_explanations(this.state.explainIndex).model_name != 'none') && <div><hr/></div>}
    ...
    {(model_explanations(this.state.explainIndex).model_name != 'none') && <div><hr/><br/></div>}
