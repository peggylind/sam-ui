export function categories(list) {
  ...
  const cat_list = [
    ...
    {category: 'education_entropy_index', pretty_name: 'educational entropy', type: 'range', low: -.01, high:-.43,
      factors:[{factorName:'low',factorColor:3},{factorName:'high',factorColor:6}],fnd:'',fnd_top_num:1000000,fnd_bottom_num:0},
      //5
    ...
    {category: 'household_income', pretty_name: 'income', type: 'range', low: 0, high:700000,
      factors:[{factorName:'low',factorColor:5},{factorName:'high',factorColor:1}],fnd:'',fnd_top_num:1000000,fnd_bottom_num:0},
      //7
    {category: 'lowbirthweightbyrace', pretty_name: 'low birthweight by race', type: 'factor',
      factors: [{factorName:'yes',factorColor:5},{factorName:'no',factorColor:1}],fnd:''},
      //8
    ...
    {category: 'racial_entropy_index', pretty_name: 'racial entropy', type: 'range', low: -.01, high:-.13, factors:
      ...
      //13
    {category: 'sex', type: 'factor', pretty_name: 'gender', factors: [{factorName:'Male',factorColor:5},{factorName:'Female',factorColor:1}],fnd:''},
      //14
    ...
    {category: 'veteran_status', pretty_name: 'veteran', type: 'factor',
      factors: [{factorName:'Nonveteran',factorColor:1},{factorName:'Veteran',factorColor:11}],fnd:''}
